...
const makeOrder_dto_1 = require("../../dto/order/makeOrder.dto");
let OrderController = exports.OrderController = class OrderController {
    ...
    async makeOrder(res, req, makeOrderDTO) {
        const profileReq = await this.orderService.makeOrder(req.user, makeOrderDTO);
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Make an order' }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, makeOrder_dto_1.MakeOrderDTO]),
    __metadata("design:returntype", Promise)
